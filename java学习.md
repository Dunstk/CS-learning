...
## 1.3Java补充知识
### 1.3.1原码 补码 反码
计算机中，数字的存储与计算的形式都是补码
![[Pasted image 20251115141104.png]]
![[Pasted image 20251115141321.png]]
1、原码
十进制数据的二进制表示形式，第一位是符号位（1表示负，0表示正）

2、反码
解决原码不能计算负数的问题出现的
负数运算时，如果结果跨0，跟实际运算结果有1的偏差
正数反码与原码一样

3、补码
解决反码的弊端而出现
正数补码与原码一样
![[Pasted image 20251115142323.png]]

### 1.3.2随机数生成
![[Pasted image 20251115153958.png]]
![[Pasted image 20251115154051.png]]
**假如我想要生成范围为7~15的数字呢？**
![[Pasted image 20251115154246.png]]
...
![[Pasted image 20251115144753.png]]可以利用->来代替break（在只有单行语句的时候可以省略大括号）
...
②数组的动态初始化：
（自己指定数组长度，由虚拟机给出默认的初始化值）
数据类型[ ]数组名=new 数据类型 [ ]
![[Pasted image 20251115160322.png]]

③静态 vs 动态
![[Pasted image 20251115160445.png]]
![[Pasted image 20251115160428.png]]

2、数组的访问
![[Pasted image 20251115155624.png]]
